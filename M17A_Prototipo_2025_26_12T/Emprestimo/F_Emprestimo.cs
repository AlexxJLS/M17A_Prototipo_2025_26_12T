...
namespace M17A_Prototipo_2025_26_12T.Emprestimo
{
    public partial class F_Emprestimo : Form
    {
        ...
        private void bt_emprestar_Click(object sender, EventArgs e)
        {
            ...
            Emprestimo emprestimo = new Emprestimo(bd);
            emprestimo.nlivro = livro_escolhido.nlivro;
            emprestimo.nleitor = leitor_escolhido.nleitor;
            emprestimo.RegistarEmprestimo();
            PreencheCBLivros();
        }
    }
}
